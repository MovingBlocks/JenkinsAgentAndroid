...
This image is built via [Kaniko](https://github.com/GoogleContainerTools/kaniko) in the [Terasology](https://terasology.org/) Jenkins with a Docker agent labeled `kaniko` - see our https://github.com/MovingBlocks/Logistics repo for further details on that setup.
